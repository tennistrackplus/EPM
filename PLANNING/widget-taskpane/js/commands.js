...
async function executeSQL(sql) {
    // ÚNICO cambio respecto al add-in original en todo este fichero: se
    // reutiliza la conexión ya autenticada de la aplicación anfitriona
    // (PLANNING) en vez de que este panel autentique por su cuenta contra
    // BigQuery/Snowflake. Ver también excelService.js::executeSQLBigQuery,
    // que recibe exactamente el mismo tratamiento.
